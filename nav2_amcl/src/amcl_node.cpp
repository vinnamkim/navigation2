  ...
  const rclcpp::Time & t, const std::string & f)
{
  ...
  ident.header.frame_id = nav2_util::strutils::stripLeadingSlash(f);
...
AmclNode::laserReceived(sensor_msgs::msg::LaserScan::ConstSharedPtr laser_scan)
{
  ...
  std::string laser_scan_frame_id = nav2_util::strutils::stripLeadingSlash(laser_scan->header.frame_id);
  ...
  if (lasers_update_[laser_index]) {
    ...
    min_q.header.frame_id = nav2_util::strutils::stripLeadingSlash(laser_scan->header.frame_id);
...
AmclNode::initParameters()
{
  ...
  odom_frame_id_   = nav2_util::strutils::stripLeadingSlash(odom_frame_id_);
  base_frame_id_   = nav2_util::strutils::stripLeadingSlash(base_frame_id_);
  global_frame_id_ = nav2_util::strutils::stripLeadingSlash(global_frame_id_);
